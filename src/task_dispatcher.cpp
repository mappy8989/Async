...
TaskDispatcher::TaskDispatcher(size_t thread_count, QueueOptions high_prio_opt, QueueOptions low_prio_opt)
...
void TaskDispatcher::schedule(TaskPriority priority, std::function<void()> task) { prio_queue_->push(priority, task); }
